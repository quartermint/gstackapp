...
- Poll `GET http://100.123.8.125:1234/v1/models` on 30-second timer
...
### Integration Points
- Health monitor: add LM Studio as a ServiceEntry (name: "LM Studio", port: 1234, host: "100.123.8.125")
