...
**Example:**
```typescript
const MC_API_URL = process.env.MC_API_URL ?? "http://100.x.x.x:3000";
...
| MCP-06 | Session startup hook surfaces critical risks | smoke | `MC_API_URL=http://100.x.x.x:3000 bash ~/.claude/hooks/risks-digest.sh` | Wave 0 |
