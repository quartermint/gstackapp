...
Output: MC API + dashboard live on http://100.123.8.125:3000 (or http://ryans-mac-mini:3000), with auto-update watcher detecting new tags.
</objective>
...
- Mac Mini SSH: ryans-mac-mini (100.123.8.125)
...
5. Visit http://ryans-mac-mini:3000 in browser -- should see MC dashboard
...
- After deployment: `curl http://ryans-mac-mini:3000/api/health` returns 200
- After deployment: `http://ryans-mac-mini:3000` serves the dashboard
</verification>

<success_criteria>
- Mission Control API running on Mac Mini :3000 via launchd (KeepAlive)
- Dashboard accessible at http://ryans-mac-mini:3000 from any Tailscale device
