...
|-------------|------------|-------------|--------|----------|
| GATE-01 | 13-01, 13-02 | MC health probe polls LM Studio API on Mac Mini (:1234) for model availability | SATISFIED | `probeLmStudio` fetches `http://100.x.x.x:1234/v1/models`; `startLmStudioProbe` runs immediately then on interval; 7 probe tests pass |
