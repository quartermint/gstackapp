...
- [x] **CAPT-03**: User can correct AI's project assignment with one click
...
| DASH-02 | Phase 2: Dashboard Core | Complete |
| DASH-03 | Phase 2: Dashboard Core | Complete |
...
| CAPT-03 | Phase 3: Capture Pipeline | Complete |
