...
- [x] **Phase 14: Dashboard & Project State** - Cross-project dashboard reading filesystem state, design docs, worklog, infra health, and PR review integration (completed 2026-04-08)
...
- [x] 14-02-PLAN.md — Design docs, worklog carryover, and infra status API routes
- [x] 14-03-PLAN.md — Dashboard frontend: project cards grid, infra panel, carryover, sidebar rewiring
- [x] 14-04-PLAN.md — Cmd+K command palette + full dashboard visual verification
